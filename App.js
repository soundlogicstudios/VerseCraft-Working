...
function clearNode(node) {
  ...
  function resolveCoverUrl(storyMeta) {
    // Canon: story.cover.path from Pack.json
    const rawPath = storyMeta?.cover?.path || null;
  ...
  function renderStories() {
    ...
    stories.forEach((s) => {
      ...
      // Background cover (Story List) — DEBUG-safe, additive
...
function init() {
    ...
    if (DEBUG) log("Build: v1.44.2-covercards");
    preloadMenuSkin();
