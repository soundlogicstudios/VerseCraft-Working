...
function clearNode(node) {
  ...
  function resolveCoverUrl(storyMeta) {
    // Uses story.cover.path from Pack.json
    const rawPath = storyMeta && storyMeta.cover && storyMeta.cover.path ? storyMeta.cover.path : null;
    ...
    // If just filename, map to covers/<file>
  ...
  function renderStories() {
    ...
    stories.forEach((s) => {
      ...
      // Cover background (Pack.json: story.cover.path)
      ...
      if (coverUrl) {
        ...
        // Debug visibility + preload result
        if (DEBUG) {
