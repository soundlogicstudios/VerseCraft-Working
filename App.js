...
(() => {
  ...
  const ENGINE_VERSION = "0.1.40";
  const CONTENT_ROOT = "./content/";
  

  // Menu background art (lowercase, canonical)
  const MENU_SKIN_SAVE_URL = "./backgrounds/ui/versecraftmenu-save.webp";
  const MENU_SKIN_NOSAVE_URL = "./backgrounds/ui/versecraftmenu-nosave.webp";
